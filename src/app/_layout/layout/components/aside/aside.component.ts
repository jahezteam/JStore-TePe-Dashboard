...
import { DrawerComponent, MenuComponent, ScrollComponent, ToggleComponent } from 'app/kt/components';
...
export class AsideComponent implements OnInit, OnDestroy {
  ...
  @ViewChild('ktAsideScroll', { static: true })
  ktAsideScroll!: ElementRef;
  private unsubscribe: Subscription[] = [];

  constructor(private layout: LayoutService, private router: Router,
    private dialogService: DialogService,private changeDetection: ChangeDetectorRef,
