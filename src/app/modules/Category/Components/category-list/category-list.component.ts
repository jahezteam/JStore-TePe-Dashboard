...
this.ref.onClose.subscribe((item: category) =>{
    if (item!=null) {
     this.service.post(item).subscribe((res:any)=>{
      if(res)
      {
        this.messageService.add({key: 'tl', severity:'success', summary: 'success', detail: 'Category Created Succesfully'});
        this.ngOnInit();
      }
      else{
        this.messageService.add({key: 'tl', severity:'error', summary: 'Error', detail: 'Error occured Please contact system adminstrator'});
    ...
    if (item!=null) {
     this.service.update(item).subscribe((res:any)=>{
      if(res)
      {
        ...
        this.messageService.add({key: 'tl', severity:'success', summary: 'success', detail: 'Category updated Succesfully'});
        this.ngOnInit();
      }
      else{
        this.messageService.add({key: 'tl', severity:'error', summary: 'Error', detail: 'Error occured Please contact system adminstrator'});
      ...
      accept: () => {
        this.service.delete(item.id).subscribe((res:any)=>{
          if(res)
          {
            ...
            this.messageService.add({key: 'tl', severity:'success', summary: 'success', detail: 'Category Deleted Succesfully'});
            this.ngOnInit()
          }
          else{
            this.messageService.add({key: 'tl', severity:'error', summary: 'Error', detail: 'Error occured Please contact system adminstrator'});
