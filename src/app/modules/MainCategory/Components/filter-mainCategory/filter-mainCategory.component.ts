...
@Component({
  selector: 'app-filter-mainCategorys',
  templateUrl: './filter-mainCategory.component.html',
  styleUrls: ['./filter-mainCategory.component.scss'],

  providers:[ValidateService,MessageService]
})
export class FilterMainCategorysComponent implements OnInit , OnDestroy {
