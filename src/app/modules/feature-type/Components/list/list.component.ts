    ...
    this.ref.onClose.subscribe((item: FeatureType) => {
      if (item != null) {
        this.service.post(item).subscribe((res: any) => {
          if (res) {
            this.messageService.add({ key: 'tl', severity: 'success', summary: 'success', detail: 'Feature Type Created Succesfully' });
            this.ngOnInit();
          }
          else {
            this.messageService.add({ key: 'tl', severity: 'error', summary: 'Error', detail: 'Error occured Please contact system adminstrator' });
      ...
      if (item != null) {
        this.service.update(item).subscribe((res: any) => {
          if (res) {
            ...
            this.messageService.add({ key: 'tl', severity: 'success', summary: 'success', detail: 'Feature Type updated Succesfully' });
            this.ngOnInit();
          }
          else {
            this.messageService.add({ key: 'tl', severity: 'error', summary: 'Error', detail: 'Error occured Please contact system adminstrator' });
    ...
    this.confirmationService.confirm({
      ...
      accept: () => {
        this.service.delete(item.id).subscribe((res: any) => {
          if (res) {
            this.messageService.add({ key: 'tl', severity: 'success', summary: 'success', detail: 'Feature Type Deleted Succesfully' });
            this.ngOnInit()
          }
          else {
            this.messageService.add({ key: 'tl', severity: 'error', summary: 'Error', detail: 'Error occured Please contact system adminstrator' });
