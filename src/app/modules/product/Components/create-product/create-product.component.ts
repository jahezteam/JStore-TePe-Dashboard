...
export class CreateProductComponent implements OnInit, OnDestroy {
  ...
  registerForm() {
    ...
    this.validationService.registerForm(["titleAr", "titleEn", "modelNumber",
  ...
  submit() {
    ...
    this.service.postFormData(formData).subscribe((res:any) => {
      if (res) {
        this.messageService.add({ key: 'tl', severity: 'success', summary: 'Success', detail: 'Product Created Succesfully' });
        this.clearInputs();
        this.registerForm();
      }
      else {
